...
public class PoseClassifierProcessor {
    ...
    private static final String POSE_SAMPLES_FILE = "pose/fitness_poses_csvs_out_null.csv";
    private static final String POSE_ACTIVITY = "pose/fitness_poses_csvs_out_null.csv";
